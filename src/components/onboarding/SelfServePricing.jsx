              ...
              {PRICING_CARDS.map((card, index) => {
                ...
                return (
                  <button key={index} onClick={() => handleSelectTier(card.key, index)}
                    ...
                    className={`pricing-card-light relative text-left rounded-2xl border-2 p-7 transition-all duration-200 bg-white shadow-lg cursor-pointer
                  ...
                  <div className="border-t border-gray-100 pt-5">
                    <div className="flex items-baseline gap-1 mb-1">
                      <span className="pricing-rate text-3xl font-black text-gray-900">{card.rate}</span>
