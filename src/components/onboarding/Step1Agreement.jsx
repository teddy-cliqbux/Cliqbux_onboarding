    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-8 pt-8 pb-6 border-b border-gray-100">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-1.5">Review & Sign Your Agreement</h2>
            <p className="text-gray-500 text-sm">
              Hello, <span className="font-semibold text-gray-700">{profile.legalName}</span>. Please review the merchant agreement below and sign to proceed.
            </p>
          </div>
          <div className="flex items-center gap-2 text-xs text-gray-400 bg-gray-50 px-3 py-2 rounded-lg ml-4">
      ...
      <div className="flex-1 px-8 py-6">
        {profile.hubspotQuoteUrl ? (
          <div className="relative rounded-xl overflow-hidden border border-gray-200 bg-gray-50" style={{ minHeight: '800px' }}>
            {iframeError ? (
              <div className="flex flex-col items-center justify-center h-full min-h-96 gap-4 p-8 text-center">
                ...
                <div>
                  <p className="font-semibold text-gray-800 mb-1">Unable to display agreement inline</p>
                  <p className="text-gray-500 text-sm mb-4">Your browser may be blocking the embedded view. Click below to open your agreement.</p>
                  <a
          ...
          <div className="flex flex-col items-center justify-center min-h-96 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200 gap-4">
            <RefreshCw className="w-8 h-8 text-gray-300 animate-spin" />
            <p className="text-gray-500 text-sm">Your agreement is being prepared. Please check back shortly.</p>
          </div>
        )}
      </div>
      ...
      <div className="px-8 pb-8">
        <div className="flex items-center gap-3 bg-amber-50 border border-amber-100 rounded-lg px-4 py-3">
          ...
          <p className="text-amber-800 text-xs">
            <span className="font-semibold">Auto-detection active:</span> Once you sign the agreement, this page will automatically advance to Step 2. No need to refresh.
          </p>
        </div>
      </div>
    </div>
